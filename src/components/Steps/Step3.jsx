    ...
    return (
      <section className="app-section-3">
        ...
        <div className="app-final-message">
          <p>
            Please send requests &amp; suggestions to{" "}
            <a href="mailto:hi@ProteinBarMix.com">hi@ProteinBarMix.com</a>.
          </p>
          <p>
            Our calculator is meant to be a general guide. We recommend apps
            like{" "}
            <a
